 ...
 *
 */
class ConfirmsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'send_message' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'send_message' => 1,
            'created' => '2016-05-08 21:03:03',
            'modified' => '2016-05-08 21:03:03'
        ],
    ];
}
